          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className={`w-full px-4 py-3 border rounded-none focus:outline-none focus:border-black transition-colors text-sm md:text-base bg-transparent appearance-none pr-10 ${
