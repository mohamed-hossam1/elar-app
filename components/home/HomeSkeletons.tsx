  ...
  return (
    <section className="w-full py-12 sm:py-20 bg-white border-b border-black/10 last:border-none">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-5xl font-integral font-black text-left mb-8 sm:mb-12 tracking-[0.04em] leading-[1.02]">
          {title}
        </h2>
...
export const CategoriesSkeleton = () => {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 mb-14 sm:mb-16">
      <div className="max-w-[1400px] mx-auto bg-white border border-black rounded-none p-6 sm:p-12 lg:p-14">
        <h2 className="text-3xl sm:text-5xl font-integral font-black text-center mb-10 sm:mb-14 tracking-[0.04em] leading-[1.02]">
          BROWSE BY STYLE
        </h2>
