    ...
    <form onSubmit={handleSubmit} className="space-y-10" autoComplete="off">
      ...
      >
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <Uploader
              label="Cover Image"
              description="This image will be used as the main product thumbnail."
              value={imageCover ? [imageCover] : []}
              onChange={(urls) => setImageCover(urls[0] || "")}
              maxFiles={1}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <label className="flex cursor-pointer items-center gap-4 border border-black bg-white p-6 transition hover:bg-black/5">
            <input
              ...
              className="h-6 w-6 border-2 border-black bg-white accent-black"
            />
          ...
          <label className="flex cursor-pointer items-center gap-4 border border-black bg-white p-6 transition hover:bg-black/5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[9px] font-bold uppercase tracking-widest text-black/40">
                Show in the top selling section
              </p>
            </div>
          </label>
        </div>
      ...
      <AdminSection title="Media Gallery">
        <Uploader
          ...
          description="Add up to 10 additional images for the product gallery."
          value={galleryUrls}
