        ...
        <div className="overflow-x-auto border border-black bg-white">
          <table className="w-full text-left text-sm">
            <thead className="border-b border-black bg-admin-bg-alt">
              <tr>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">#</th>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">Customer</th>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">Date</th>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">Status</th>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">Total</th>
                <th className="p-4 font-black uppercase tracking-widest text-[11px]">Payment</th>
