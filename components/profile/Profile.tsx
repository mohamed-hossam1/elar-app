        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-black flex items-center justify-center text-white text-3xl sm:text-4xl font-black font-integral border border-black">
                {userData?.name?.[0] ?? "U"}
              </div>
              <div>
                ...
                <p className="text-black/60 text-xs sm:text-sm font-bold uppercase tracking-[0.3em] mt-1">
                  Verified Member
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/orders"
              className="px-8 py-4 bg-white text-black text-[10px] font-black uppercase tracking-[0.2em] border border-black hover:bg-black hover:text-white transition-all flex items-center gap-2"
            >
              View My Orders
            </Link>
            <Link
        ...
        <div className="grid gap-20">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <section className="space-y-8">
              ...
              <div className="bg-black/5 p-6 border border-black/10 group hover:border-black transition-all">
