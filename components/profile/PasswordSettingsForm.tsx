...
const InputField = ({
  ...
  <div className="w-full space-y-2">
    <label htmlFor={id} className="text-[10px] uppercase font-black text-black/60 tracking-[0.2em] block">
      {label}
    </label>
    <input
      id={id}
  ...
  return (
    <div className="bg-white border border-black p-8 sm:p-12 font-satoshi relative overflow-hidden">
      <div className="mb-10">
        ...
        <p className="text-black/60 text-xs mt-4 font-bold uppercase tracking-widest">Update your login password</p>
      </div>
      ...
      <form className="space-y-8" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex justify-end pt-6 border-t border-black/5">
          <button
            type="submit"
            className="button-primary gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
